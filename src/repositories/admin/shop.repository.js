...
class ShopRepository {
  ...
  // Kiểm tra Slug tồn tại chưa (Chỉ check những shop chưa bị xóa)
  ...
  // ĐÃ SỬA: Thêm mới (Sử dụng Upsert để khôi phục nếu slug đã tồn tại nhưng bị xóa mềm)
  ...
  static async softDelete(id) {
    const sql = `
      UPDATE shops 
      SET is_deleted = true, status = 'inactive', deleted_at = NOW(), updated_at = NOW()
